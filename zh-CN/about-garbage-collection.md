...
* 释放资源的时机不确定导致程序行为难以控制，造成额外的风险和成本：
	...
	* 附带的 [object resurrection](https://en.wikipedia.org/wiki/Object_resurrection) 问题引起潜在的 bug 、混乱的程序流程和逻辑并降低程序的可维护性。（另外一个类似但不同的失败例是传统 UNIX 允许[僵尸进程](https://zh.wikipedia.org/wiki/%E5%83%B5%E5%B0%B8%E8%BF%9B%E7%A8%8B) 的设计。）
* 使程序逻辑复杂化：
